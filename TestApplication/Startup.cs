...
namespace TestApplication
{
    public class Startup
    {
        ...
        private void AddApiManager(IServiceCollection services)
        {
            ...
            var options = Configuration.GetSection($"ApiManagerOptions").Get<ApiManagerOptions>();
            services.AddApiManager(connectionString, options).PrepareApiManager();
        }
